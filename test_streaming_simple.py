#!/usr/bin/env python3
"""
Script simples para testar o endpoint de streaming do chat usando apenas bibliotecas padrão.
"""
import json
import sys
import time
                ...
                if line.startswith('data: '):
                    try:
                        ...
                        if event_type == 'start':
                            ...
                            print(f"✅ Chunk recebido: {content[:30]}..." if len(content) > 30 else content)
...
def test_multiple_workspaces():
    ...
    for workspace in workspaces:
        ...
        success = test_streaming(workspace_id=workspace)
